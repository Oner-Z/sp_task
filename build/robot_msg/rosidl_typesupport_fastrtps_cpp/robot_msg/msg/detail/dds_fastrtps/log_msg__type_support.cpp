...
#include "robot_msg/msg/detail/log_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_msg::msg::LogMsg & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.diagnostic_info;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_msg::msg::LogMsg & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msg::msg::LogMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msg::msg::LogMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_msg::msg::LogMsg *>(
    untyped_ros_message);
...
get_message_type_support_handle<robot_msg::msg::LogMsg>()
{
  return &robot_msg::msg::typesupport_fastrtps_cpp::_LogMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msg, msg, LogMsg)() {
  return &robot_msg::msg::typesupport_fastrtps_cpp::_LogMsg__handle;
}
